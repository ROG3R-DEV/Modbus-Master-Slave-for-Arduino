...
uint16_t diagnostic_register[NUM_COUNTERS];
RegisterBlockData diagnostic_register_block(diagnostic_register, NUM_COUNTERS, 31000);
...
/*********************************************************
 ...
 ES: pin 13 (LED_BUILTIN) reservado para ver el estado de la comunicación
...
void mapping_poll() {
  ...
  //     del vector (es lo mismo que hacer una máscara).
  ...
  // ES: Lee las entradas analógicas (ADC).
...
void setup() {
  ...
  // ES: Abre la comunicación como esclavo
  // EN: Start comms.
